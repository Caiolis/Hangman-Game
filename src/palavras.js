// This file contains an array with all possible words that can appear in the game.
// Do not change the name of the array nor the export, but feel free to add new words.
